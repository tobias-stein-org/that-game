...
public class ModuleSimilarity : EditorWindow
{
    [SerializeField]
    private VisualTreeAsset m_VisualTreeAsset = default;

    [MenuItem("MapGen/ModuleSimilarity")]
    public static void OpenWindow()
    {
        ModuleSimilarity wnd = GetWindow<ModuleSimilarity>();
        wnd.titleContent = new GUIContent("ModuleSimilarity");
    ...
    public void CreateGUI()
    {
        ...
        this.deny = Base64ToTexture(s_XIconString);
        // Instantiate UXML
    ...
    [MenuItem("Assets/MapGen/Module Similarity")]
    ...
    private Texture2D getBorder(Texture2D a, Step3.ModuleConstraints.Side side)
    {
        var X = a.width;
        var Y = a.height;
        var P = a.GetPixels();
    ...
    private Texture2D getSimilar(Texture2D a, Texture2D b, Step3.ModuleConstraints.Side side)
    {
