...
namespace tg.ai.steering
{
    namespace entities
    {
        ...
        public partial class SteeringBehaviourGroup : ComponentSystemGroup
        {
            ...
            {
                base.OnCreate();
                this.RateManager = new RateUtils.VariableRateManager(SteeringBehaviourGroup.UPDATE_RATE_MS, true);
            }
        }
    }
}
